...
func TestRun(t *testing.T) {
	...
	receivedMessage := []byte(`{"Id":"51395b2a-b09d-4a1b-87f5-7ca1a9039aa3","Name":"HTTP_TEST","SensorId":"e26e85a8-aa99-43d0-8e1a-78b6056449a2","HttpOpts":{"TargetDomain":"https://google.com","HttpMethod":"GET","RequestHeaders":{"Content-Type":["application/json"]},"RequestBody":"c29tZSB0ZXN0IGJvZHk=","ResultWithResponseBody":true,"ResultWithResponseHeaders":true}}`)
