...
func TestTracerouteTaskMockedFromBytes(t *testing.T) {
	...
	receivedMessage := []byte(`{"Id":"3b241101-e2bb-4255-8caf-4136c566a964","Name":"TRACEROUTE_TASK","SensorID":"3b241101-e2bb-4255-8caf-4136c566a964","Opts":{"Port":33434,"Dest":"8.8.8.8","FirstHop":1,"MaxHops":64,"Timeout":500,"PacketSize":52,"Retries":3, "NetCapRaw":false}}`)
...
func TestTracerouteTaskMockedFromModel(t *testing.T) {
	...
	modelTask := models.Task{
		...
		CreatedAt:      createdAt,
		Opts:           []byte(`{"Port":33434,"Dest":"8.8.8.8","FirstHop":1,"MaxHops":64,"Timeout":500,"PacketSize":52,"Retries":3, "NetCapRaw":false}`),
	}
...
func TestTracerouteTaskRealFromModel(t *testing.T) {
	...
	modelTask := models.Task{
		...
		Subscription:   subscription,
		CreatedAt:      createdAt,
		Opts:           []byte(`{"Port":33434,"Dest":"8.8.8.8","FirstHop":1,"MaxHops":64,"Timeout":500,"PacketSize":52,"Retries":3, "NetCapRaw":true}`),
	}
